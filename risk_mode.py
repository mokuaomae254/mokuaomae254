...
def crypto_analytics():
	...
	with tab6:
     ...
     """
		if(risk_mode=="Welcome to the bull market!"):
			portfolio_design()
		elif(risk_mode=="Welcome to the bear market!"):
			st.write("be conservative")   """ 
	with tab7:
		altcoinseason()
