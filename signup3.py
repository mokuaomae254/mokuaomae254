...
def crypto_analytics():
	...
	#st.set_page_config(layout="wide")
	tab1, tab2, tab3,tab4,tab5,tab6,tab7,tab8,tab9 = st.tabs(["RISK DISCLAIMER","Top 100 Cryptocurrencies","Macro Analysis", "Sentiment Analysis", "portfolio design and risk management","Risk Mode","Altcoin Season Index","Profit Taking and DCA","Market Report"])
	with tab1:
